(function ($) {
  ...
  $('.category__button_show').on('click', function () {    
  ...
  // ========================= animation (animate_once)script start ===================
  // document.addEventListener("DOMContentLoaded", function () {  
  //     const targets = document.querySelectorAll('.animate_once');  

  //     const observer = new IntersectionObserver((entries) => {  
  //         entries.forEach(entry => {  
  //             if (entry.isIntersecting) {  
  //                 entry.target.classList.add('slideInRightOnce');   
  ...
  //     });  
  // });  
    // ========================= animation (animate_once)script end =====================

  //sponser slider
  $('.top-selling-product-slider-sponser').slick({
    slidesToShow: 4,
    slidesToScroll: 1,
    autoplay: true,
    autoplaySpeed: 2000,
    ...
    speed: 900,
    infinite: true,
    nextArrow: '#top-selling-next-sponser',
    prevArrow: '#top-selling-prev-sponser',
    responsive: [
      {
        breakpoint: 1399,
        settings: {
  ...
  //   speed: 900,
  //   infinite: true,
  //   // prevArrow: '<button type="button" class="followed_arrow_js_prev slick-prev border border-gray-100 w-30 h-30 bg-transparent rounded-pill position-absolute hover-bg-main-600 hover-text-white hover-border-main-600 transition-1"><i class="ph ph-caret-left"></i></button>',
  //   // nextArrow: '<button type="button" class="followed_arrow_js_next slick-next border border-gray-100 w-30 h-30 bg-transparent rounded-pill position-absolute hover-bg-main-600 hover-text-white hover-border-main-600 transition-1"><i class="ph ph-caret-right"></i></button>',
  // });  
  ...
  $('.short-product-list').slick({
    ...
    speed: 900,
    infinite: true,
    nextArrow: '#short-product-list-next',
    prevArrow: '#short-product-list-prev',
    responsive: [
      {
        breakpoint: 1399,
        settings: {
...
// ========================= hot deals Slider Js End ===================
  ...
  $('.category-two .category__button_show').on('click', function () {
    $(this).toggleClass('active');
    $('.responsive-dropdown.style-two').stop().slideToggle(400);
    $('.responsive-dropdown.style-two.after-login').addClass('active').slideToggle(400); 
  ...
  // ========================= Featured Products Slider Js End ==================
    ...
    // ========================= Featured Products Slider Js Start ==============
    $('.featured-product-slider-follow').slick({
      slidesToShow: 2,
      slidesToScroll: 1,
      autoplay: true,
      autoplaySpeed: 2000,
      ...
      speed: 900,
      infinite: true,
      nextArrow: '#featured-products-next-follow',
      prevArrow: '#featured-products-prev-follow',
      responsive: [
        {
          breakpoint: 991,
          settings: {
  ...
  // ========================== Text Slide Js Start =====================
    ...
    // commented this script for manage-business.blade for expand_btn..
  ...
  //   var countDownDate = new Date("2026-01-28 00:00:00").getTime();
  ...
  // ========================= Preloader Js Start =====================
    ...
    // ========================= Manage phone menu =====================
    function toggleMenu() {
        const manageMenu = document.querySelector('.manage_menu');
        manageMenu.classList.toggle('show-menu');
    }

    function toggleFollowedMenu() {
        const followedMenu = document.querySelector('.followed_menu');
        followedMenu.classList.toggle('show-menu');
    }
    // ========================= Manage phone menu  =====================
    ...
    // ========================= Zoom Preview  =====================
    // document.addEventListener("DOMContentLoaded", function () {
    //   const zoomPreviewContainer = document.querySelector('.zoom-preview-container');
    //   const zoomPreviewImage = document.getElementById('zoom-preview');
    //   const thumbnails = document.querySelectorAll('.product_detail_main_img');
    //   const scale = 2; // Zoom level

    //   thumbnails.forEach(thumbnail => {
    //       thumbnail.addEventListener('mouseover', function () {
    //           zoomPreviewImage.src = this.src;
    //           zoomPreviewContainer.style.display = 'block';
    //       });

    //       thumbnail.addEventListener('mousemove', function (event) {
    //           const rect = this.getBoundingClientRect();
    //           const x = event.clientX - rect.left; // Mouse X relative to image
    //           const y = event.clientY - rect.top;  // Mouse Y relative to image
    //           const containerWidth = zoomPreviewContainer.offsetWidth;
    //           const containerHeight = zoomPreviewContainer.offsetHeight;

    //           // Calculate translation to center cursor position
    //           const translateX = (containerWidth / 2 - x * scale);
    //           const translateY = (containerHeight / 2 - y * scale);

    //           // Apply transforms
    //           zoomPreviewImage.style.transform = `scale(${scale}) translate(${translateX}px, ${translateY}px)`;
    //       });

    //       thumbnail.addEventListener('mouseout', function () {
    //           zoomPreviewContainer.style.display = 'none';
    //           zoomPreviewImage.style.transform = 'none';
    //       });
    //   });
    // });
    // ========================= Zoom Preview =====================
